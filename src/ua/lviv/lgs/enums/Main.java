...
public class Main {
    ...
    public static void main(String[] args) throws WrongInputConsoleParametersException {
        Month[] arrayMonths = Month.values(); //Array of Months
        Season[] arraySeasons = Season.values(); //Array of Seasons

        start(); // Opening text
        while (true) {
            Scanner scanner = new Scanner(System.in);
            int num = scanner.nextInt(); //Person's choice
            switch (num) {
                case 0:
                ...
                case 1:
                    ...
                    if (!flag) {
                        System.err.println("Такої пори року не існує");
                ...
                case 2:
                    ...
                    if (!flag) {
                        System.err.println("Такої кількості днів в місяці не існує");
                        throw new WrongInputConsoleParametersException();
                    }
                    break;
                ...
                case 9:
                    ...
                    if (!flag) {
                        System.err.println("Немає такого місяця");
                        throw new WrongInputConsoleParametersException();
                    }
                    break;
    ...
    /**
     * Checking is the month exixt
     *
     * @param arrayMonths, monthName
     *
     * @return boolean expression
     * */
    private static boolean isMonthExist(Month[] arrayMonths, String monthName) {
        boolean flag = false;
